...
<div align="center">
    <p align="center" style="font-style:italic; color:gray;">
        Zero-dependency CLI framework for fast, organized,<br>
    ...
    <img src="https://img.shields.io/github/stars/langpkg/cli?style=social" alt="GitHub Repo stars" />
</div>
<br>
...
- ## Docs
    ...
    - ### Error Handling
        ...
        ```typescript
        import { CLIError, ValidationError, CommandNotFoundError } from '@langpkg/cli';
